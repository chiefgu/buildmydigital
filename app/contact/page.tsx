        ...
        <div className="mx-auto w-full relative z-10" style={{ maxWidth: '900px' }}>
          ...
          <div className="text-center text-white mb-12">
            ...
            <div className="flex flex-row gap-12 justify-center mb-8">
              <div>
                <div className="text-4xl font-semibold mb-2">24hrs</div>
            ...
            {isSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-[#EF8354] to-[#d97446] text-white font-semibold rounded-full hover:shadow-xl hover:shadow-[#EF8354]/30 transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 relative overflow-hidden"
                >
      ...
      <section className="px-6 bg-gradient-to-br from-gray-50 to-white" style={{paddingTop: '80px', paddingBottom: '80px'}}>
        <div className="max-w-[900px] mx-auto">
          <div className="text-center mb-12">
            <h2
              className="font-semibold leading-[1.1] tracking-[-0.03em] text-black mb-4"
              style={{
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-20">
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto md:min-w-[385px]">
              <a
                href="/contact"
                className="w-full px-8 py-5 rounded-full bg-white border border-black text-black text-[22px] font-normal text-center hover:bg-gray-100 transition-all hover:-translate-y-0.5"
              >
                Get started for free
              </a>
              <a
                href="/contact"
                className="w-full px-8 py-5 rounded-full bg-black border border-white text-white text-[22px] font-normal text-center hover:bg-gray-900 transition-all hover:-translate-y-0.5"
              >
                Contact us
              </a>
            </div>
